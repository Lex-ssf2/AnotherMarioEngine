package com.smbc.character 
{
	 ...
	 * @author Josned
	 */
	public dynamic class AngryMario extends Character 
	{
		
		public function AngryMario(levelData:Level) 
		{
			super(levelData);
		}
		...
		{
			super.init(e);
			m_currentSheet = new SpriteSheetLoader(MarioSkins.getBitmap(1), 16, 16, 18, 1);
